...
Go to <a href="https://github.com/skalenetwork/multisigwallet-cli/releases" target="_blank">releases</a> and take the latest version of the project. Download the `multisigwallet-cli.zip` and unpack the archive. Run `yarn install` and setup `.env`
